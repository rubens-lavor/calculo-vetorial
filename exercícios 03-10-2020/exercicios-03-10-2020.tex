...
\begin{enumerate}
    \item[\textbf{1}]- Encontrar o trabalho realizado pelo campo $\vec{F}(x,y,z)=\dfrac{k}{x^2+y^2+z^2}(x\vec{i}+y\vec{j}+z\vec{k})$ ao longo da curva $\gamma(t)=(\cos t,\sin t,t)$

          \textbf{Resolução:} Procuraremos $f=f(x,y,z)$ tal que:

          \begin{equation}
              \dfrac{\partial f}{\partial x}(x,y,z)=\dfrac{k_x}{x^2+y^2+z^2}
          \end{equation}
          \begin{equation}
              \dfrac{\partial f}{\partial y}(x,y,z)=\dfrac{k_y}{x^2+y^2+z^2}
          \end{equation}
          \begin{equation}
              \dfrac{\partial f}{\partial z}(x,y,z)=\dfrac{k_z}{x^2+y^2+z^2}
          \end{equation}
          ...
          \begin{center}
              ...
              $f(x,y,z)=\integral \frac{k_x}{{x^2+y^2+z^2}\,dx + \phi (y,z) = \frac{k}{2} \ln(x^2+y^2+z^2)+ \phi (y,z),$
          ...
          \begin{center}
              ...
              $\dfrac{\partial f}{\partial y}(x,y,z)=\dfrac{k_y}{{x^2+y^2+z^2}+\dfrac{\p{x^2+y^2+z^2} \Longrightarrow \dfrac{\partial \phi}{\partial y}(y,z)= 0 \Longrightarrow \phi (y,z) = \phi(z),$
          \end{center}
